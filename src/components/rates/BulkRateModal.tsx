...
import type { BulkRateUpdateInput, RatePlan } from "@/lib/types";
import { WEEKDAYS } from "./ratesUtils";
...
interface BulkRateModalProps {
  ...
  defaultDate: string;
  onApply: (input: BulkRateUpdateInput) => Promise<boolean>;
}

const BulkRateModal: React.FC<BulkRateModalProps> = ({
  isOpen,
  onClose,
  plans,
  selectedPlanIds,
  ...
  return (
    <Modal isOpen={isOpen} onClose={onClose} className="max-h-[90vh] max-w-lg overflow-y-auto p-6 lg:p-8">
      ...
      <p className="mb-6 text-sm text-gray-500 dark:text-gray-400">
        Apply a new rate or availability across selected rate plans and dates.
      </p>
